    ...
    <asp:Content ContentPlaceHolderID="HeadContent" runat="server">
        <style>
            ...
            /* Panel alignment fix forcing the panel to not interfere with the grid row */
            .grid-panel { 
                width: 100%;
            }
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:RequiredFieldValidator ID="rfvSubject" runat="server" ControlToValidate="txtSubject" 
                                    CssClass="text-danger" Display="None" ErrorMessage="Subject is required"   />
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:RequiredFieldValidator Id="rfvddlLeaveType" runat="server" ControlToValidate="ddlLeaveType" 
                                    InitialValue="" CssClass="text-danger" Display="None" ErrorMessage="Leave type is required"  />
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="calFromDate" runat="server"
                                            TargetControlId="txtFromDate" Format="yyyy-MM-dd" PopupPosition="BottomLeft" />
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:RequiredFieldValidator Id="rfvReason" runat="server" ControlToValidate="txtReason" 
                                    Display="None" CssClass="text-danger" ErrorMessage="Reason is required"  />
                            </div>
